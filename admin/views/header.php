...
<!-- Yardım Al -->
  <div class="modal fade" id="bilgiAl" role="dialog">
    ...
    <p><strong>Developed By : <a href="https://ecoda.store">ecoda.store</a></strong></p>
<p><strong>Contact US : <a href="https://t.me/JohnsonGaming123">Click Here</a></strong></p>
</body>
                </h4>
                <hr>
                
<h4>Payment Gateways Return Addresses</h4>
Paytr Return Address: <code><?=site_url()?>payment</code><br>
Paywant Return Address: <code><?=site_url()?>payment</code><br>
Buypayer Return Address: <code><?=site_url()?>payment</code><br>
Shopier Return Address: <code><?=site_url()?>paymentr</code><br>
<hr>
