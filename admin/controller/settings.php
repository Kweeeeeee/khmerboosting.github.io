<?php
  ...
  $menuList = ["General Settings"=>"general","Meta (SEO) Settings"=>"meta","Page Posts"=>"pages","Payment settings"=>"payment-methods","Bank Accounts"=>"bank-accounts","Payment bonuses"=>"payment-bonuses","Notification settings"=>"alert","Service providers"=>"providers","Language editor"=>"language","Theme editor"=>"themes"];
